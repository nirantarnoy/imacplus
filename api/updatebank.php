...
if ($requestMethod == 'POST') {
    ...
    $bank_id = $reqjsonDecode['bank_id'];
    $account_no = $reqjsonDecode['account_no'];
    $account_name = $reqjsonDecode['account_name'];
...
//        }
        ...
        $has = checkHasRow($connect, $member_id);
        if ($has > 0) {
            $sql = "UPDATE member_account SET bank_id='$bank_id',account_no ='$account_no', account_name='$account_name' WHERE member_id='$member_id'";
            ...
            $sql = "INSERT INTO member_account (member_id,account_no,account_name,bank_id,created_at,created_by)
           VALUES ('$member_id','$account_no','$account_name','$bank_id','$created_at','$member_id')";
