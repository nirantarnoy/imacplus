...
//if ($province_id > 0) {
    $query = "SELECT t1.id,t1.part_name,t1.cost_price,t1.description,t2.name,t3.qty FROM sparepart as t1 LEFT JOIN sparepart_type as t2 ON t1.part_type_id = t2.id LEFT JOIN sparepart_stock as t3 ON t1.id = t3.sparepart_id WHERE t1.id > 0 ";
    ...
    if($filtered_rows > 0){
        foreach($result as $row){
            ...
            $html .= '<td style="text-align: center">
                        ...
                        <input type="hidden" class="line-find-price" value="' . $row['cost_price'] . '">
