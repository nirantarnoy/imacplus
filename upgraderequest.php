...
<!--                <a href="#" class="f-n-hover btn btn-blue btn-raised px-4 py-25 w-75 text-600">Get Started</a>-->
<!--            </div>-->
<!--        </div>-->
<!---->
<!--    </div>-->
...
<!--                </li>-->
            ...
            <div class="col-12 col-md-4 text-center">
                <a href="#" class="f-n-hover btn btn-grey btn-raised px-4 py-25 w-75 text-600" onclick="choosepackage($(this))">เลือกแพ็คเก็จ</a>
            </div>
        </div>
