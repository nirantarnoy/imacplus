...
<div class="row">
        ...
        <div class="card" style="border-color: #5bb15b;border-width: 3px;background-color: #f0efef">
            <div class="card-body">
                        ...
                        <div class="d-flex flex-column py-3 px-lg-3 justify-content-center align-items-center">
                            ...
                            <div class="mx-auto mt-25 text-center">
                                ...
                                <a href="profile_editpage.php?refid=<?= $member_id ?>"
                                   class="btn btn-info btn-edit-data">แก้ไขข้อมูลส่วนตัว</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn" style="background-color: white;border-color: #5bb15b;width: 100%;border-width: 2px;border-radius: 10px;">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div style="width: 100%;height: 100%;margin-top: 10px;">
                                                <img alt="Profile image"
                                                     src="assets/iCOn/iCOn/work_photo.png" style="width: 100%;"/>
                                            </div>
                                        </div>
                ...
                <div class="d-flex flex-column py-3 px-lg-3 justify-content-center align-items-center">
                    ...
                    <div class="row w-100">
                        <div class="col-lg-6">
                            <a href="workorder.php?element=1" role="button"
                               class="d-style btn btn-lighter-secondary btn-h-outline-purple btn-a-outline-purple btn-a-bgc-white w-100 border-t-3 my-1 py-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <a href="dropoff.php?element=1" role="button"
                               class="d-style btn btn-lighter-secondary btn-h-outline-purple btn-a-outline-purple btn-a-bgc-white w-100 border-t-3 my-1 py-3">
                                <input type="radio" name="transportation" value="train" class="invisible pos-abs"/>
                    ...
                    <div class="row w-100">
                        <div class="col-lg-4">
                            ...
                            <a href="upgraderequest.php?element=1"
                               class="btn btn-warning radius-3 border-b-8 py-25 btn-bold btn-text-slide-x mb-2"
                               style="width: 100%;">
                        ...
                        <div class="col-lg-4">
                            ...
                            <a href="walletlist.php?element=1"
                               class="btn btn-primary radius-3 border-b-8 py-25 btn-bold btn-text-slide-x mb-2"
                               style="width: 100%;">
                                <!-- width should be fixed -->
                                <span class="btn-text-2 move-right">
                                    <span class="d-inline-block bgc-white-tp9 shadow-sm radius-2px h-4 px-25 pt-1 mr-1 border-1">
                        ...
                        <div class="col-lg-4">
                            ...
                            <!--                                mPoint</a>-->
                            <a href="witdrawlist.php?element=1"
                               class="btn btn-info radius-3 border-b-8 py-25 btn-bold btn-text-slide-x mb-2"
                               style="width: 100%;">
                                <!-- width should be fixed -->
                                <span class="btn-text-2 move-right">
                                    <span class="d-inline-block bgc-white-tp9 shadow-sm radius-2px h-4 px-25 pt-1 mr-1 border-1">
    ...
    <div class="col-lg-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="btn" style="border-radius: 10px;background-color: #5bb15b;width: 100%">
